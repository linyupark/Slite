define (require, exports) ->
    ...
    最后一个字符
    ###
    exports.lastChar = (str)-> str.charAt str.length - 1
    ...
    判断是否为Int
    ###
    exports.isInt = (str)-> str.match(/[0-9 -()+]+$/) isnt null
    ...
    提取中文
    ###
    exports.fetchCN = (str)-> str.replace /[u4e00-u9fa5]/g, ''
    
    
    ###
    过滤中文
    ###
    exports.cleanCN = (str)-> str.replace /[^u4e00-u9fa5]/g, ''
    
    
    ###
    是否全中文
    ###
    exports.isCn = (str)-> /[u4e00-u9fa5]/.test(str) is no
    ...
    获取URL地址中某参数值
    ###
    exports.getQuery = (name, url=window.location.href)-> new RegExp("[\\?&amp;]#{name}=([^&amp;#]*)").exec(url)[1]
    ...
    高亮
    ###
    exports.highlight = (str, words=[], tag='span')->
    ...
    取消高亮
    ###
    exports.unhighlight = (str, tag='span')->
    ...
    概要
    ###
    exports.summary = (str, limit, tail='...')->
        str = str.split ''
        if str.length > limit
            str = str[0...limit]
            str.push(tail)
